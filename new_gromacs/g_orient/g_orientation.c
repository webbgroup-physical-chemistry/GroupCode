...
int main(int argc,char *argv[])
{
    static char *desc[] = {
        ...
        "wayside for now.",
        "    The -sp flag causes the vector angles in spherical-polar coordinates to be returned, instead of the angle off each eigenvector."
    };
    ...
    rvec       n_bondvector;
    FILE       *outputfile;
    bool       bVerbose=FALSE, docorr=FALSE, spherical_polar=TRUE;
